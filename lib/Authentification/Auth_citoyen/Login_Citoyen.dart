// ignore_for_file: file_names, deprecated_member_use, prefer_const_literals_to_create_immutables, unnecessary_string_escapes, avoid_print, prefer_final_fields

import 'package:firebase_auth/firebase_auth.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:smart_garbage_collection/Authentification/Auth_citoyen/SignUp_Citoyen.dart';
import 'package:smart_garbage_collection/Authentification/ResetPassword.dart';
        ...
        await _auth
            ...
            .then((uid) => {
                  ...
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => MyORSmapsCitoyen())),
                });
